...
for cenario, docs in data_final['Cenários'].items():
    ids[cenario] = [doc['_id'] for doc in docs]
...
# Verifica se o botão clicado está presente nos IDs

if nome_botao in ids:
    print("Botão clicado está presente nos IDs")
    # Remove todos os IDs que pertencem ao cenário correspondente ao botão clicado
