...
n = len(lista_agrupada)


def lista_cards_divs(lista_agrupada: list[list[dict]], funcao_card_cenario: cards_cenarios_salvos) -> list[html.Div]:
    lista_agrupada_2 = agrupar_por_chaves(lista_agrupada)
    lista_divs = [funcao_card_cenario(lista=lista) for lista in lista_agrupada_2]
    return lista_divs
...
app.layout = html.Div(children=[
    ...
    cards_cenarios_salvos(lista=lista_dict),
